<html>
   ...
   <body>
         ...
         if(isset($_SESSION['pid']));
         {
          ...
          $accept=mysqli_query($conn,"SELECT * FROM  WHERE pid='$pid'");
              ...
              if(isset($_POST['update']))
                {
                  ...
                  if($image1){
                   ...
                   echo $picture1;
                    ...
                    $update=mysqli_query($conn,"UPDATE psr SET title='$title1',comment='$comment1',image='$picture1',weblink='$weblink1',email='$email1' WHERE pid='$id'");
                    if($update)
                    {
                      echo"<script>";
